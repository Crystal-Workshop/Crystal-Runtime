...
fn main() {
    panic!("crystal-runtime binary is only available on native targets");
}
...
mod native {
    ...
    use crystal_runtime::app::{
        camera_from_objects, light_from_objects, print_final_state, WindowViewport,
    };
    use crystal_runtime::input::{map_virtual_keycode, mouse_button_from_winit};
    use crystal_runtime::{
